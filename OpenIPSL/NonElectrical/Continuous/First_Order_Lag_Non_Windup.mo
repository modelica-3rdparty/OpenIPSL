...
model First_Order_Lag_Non_Windup
...
equation
  ...
  connect(integrator.y, feedback.u2) annotation (Line(points={{85,0},{90,0},{90,
          -46},{-30,-46},{-30,-8}}, color={0,0,127}));
  annotation (
    Icon(coordinateSystem(preserveAspectRatio=false), graphics={Rectangle(
            extent={{-100,100},{100,-100}}, lineColor={28,108,200})}),
    Diagram(coordinateSystem(preserveAspectRatio=false)));
end First_Order_Lag_Non_Windup;
