...
model PVD1
  ...
  Modelica.Blocks.Sources.Step voltage(
    ...
    startTime=0.5) annotation (Placement(transformation(
        origin={70,-20},
        extent={{10,-10},{-10,10}})));
  Electrical.Solar.PowerFactory.General.ElmVac elmVac(angle_0=0, v_0=1) annotation (Placement(transformation(
        origin={30,0},
        extent={{10,-10},{-10,10}})));
  Electrical.Solar.PowerFactory.WECC.PVD1.PlantPVD1 plantPVD1(
    M_b(displayUnit="V.A") = 0.5e6,
    P_0=300000,
    Q_0=100000) annotation (Placement(transformation(
        origin={-30,0},
        extent={{-10,-10},{10,10}})));
  inner Electrical.SystemBase SysData annotation (Placement(transformation(
        origin={-70.5,90},
