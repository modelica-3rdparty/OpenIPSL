...
equation
  ...
  connect(wind.regulate_vi, pwVoltage.vi)
    annotation (Line(points={{-44,8.6},{-44,30},{-36.6,30}}, color={0,0,127}));
  connect(pwVoltage.vr, wind.regulate_vr) annotation (Line(points={{-36.6,33.6},
          {-56,33.6},{-56,8.6}}, color={0,0,127}));
  connect(wind.branch_ir, pwCurrent.ir) annotation (Line(points={{-44,-8.6},{
          -44,-16},{-17.6,-16},{-17.6,-6.6}}, color={0,0,127}));
  connect(pwCurrent.ii, wind.branch_ii) annotation (Line(points={{-14,-6.6},{
          -14,-20},{-56,-20},{-56,-8.6}}, color={0,0,127}));
