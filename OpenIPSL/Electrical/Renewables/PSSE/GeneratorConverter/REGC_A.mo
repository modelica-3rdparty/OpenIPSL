within OpenIPSL.Electrical.Renewables.PSSE.GeneratorConverter;
model REGC_A "Renewable Energy Generator/Converter Model A"
  extends
    OpenIPSL.Electrical.Renewables.PSSE.GeneratorConverter.BaseClasses.baseRenewableGenerator;
  ...
  MicroGrid.Electrical.Renewables.WECC.Logic_Blocks.REGCA_Logic_Blocks.Low_Voltage_Active_Current_Management
  ...
  MicroGrid.Electrical.Renewables.WECC.Logic_Blocks.REGCA_Logic_Blocks.Low_Voltage_Power_Logic
    LVPL(
    Brkpt=Brkpt,
    Lvpl1=Lvpl1,
    Zerox=Zerox)
...
equation
  ...
  connect(IOLIM.u,add1. y)
    annotation (Line(points={{78,36},{39,36}},   color={0,0,127}));
  connect(LVPL.V,simpleLag. y)
    annotation (Line(points={{11,-70},{23,-70}}, color={0,0,127}));
  connect(LVACM.y,IP. u2) annotation (Line(points={{83,-70},{88,-70},{88,-34},{
          72,-34},{72,-22},{78,-22}},
                             color={0,0,127}));
  ...
  connect(add3.y,limiter1. u)
    annotation (Line(points={{-65,74},{-52,74}},color={0,0,127}));
  connect(limiter1.y,integrator. u)
    annotation (Line(points={{-29,74},{-12,74}},
                                               color={0,0,127}));
  connect(integrator.y,add3. u2) annotation (Line(points={{11,74},{16,74},{16,56},
          {-94,56},{-94,68},{-88,68}},     color={0,0,127}));
  ...
  connect(gain.u, Iqcmd) annotation (Line(points={{-122,80},{-160,80}},
                      color={0,0,127}));
  connect(add1.u1,add3. u2) annotation (Line(points={{16,42},{-6,42},{-6,56},{-94,
          56},{-94,68},{-88,68}},                      color={0,0,127}));
  ...
  connect(IP.u1, add2.u2) annotation (Line(points={{78,-10},{-118,-10},{-118,
          -36},{-112,-36}}, color={0,0,127}));
