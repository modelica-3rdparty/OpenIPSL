...
model REECCU1
  ...
  OpenIPSL.Electrical.Renewables.PSSE.RenewableElectricalController.BaseClasses.SOC_logic
  ...
  OpenIPSL.Electrical.Renewables.PSSE.RenewableElectricalController.BaseClasses.CCL_REECC
    ccl_reecc(
    start_ii=-Iq0,
    start_ir=Ip0,
    Imax=Imax)
