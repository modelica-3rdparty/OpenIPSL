...
model CTG1MachineOnly
  "Generation group for CTG1 containing only the synchronous machine"
  ...
  DynParamRecords.GUDynamics guData(redeclare record GUnitDynamics =
        OpenIPSL.Examples.Microgrids.UniversityCampus.CampusA.GenerationGroups.DynParamRecords.CTG1)
...
equation
  ...
  connect(machine.EFD0, exciter.EFD0) annotation (Line(points={{61,-5},{66,-5},{
          66,-34},{-32,-34},{-32,-13.8},{-29.9,-13.8}},          color={0,0,127}));
  connect(exciter.ECOMP, machine.ETERM) annotation (Line(points={{-29.9,-7},{-32,
          -7},{-32,20},{68,20},{68,-3},{61,-3}},            color={0,0,127}));
