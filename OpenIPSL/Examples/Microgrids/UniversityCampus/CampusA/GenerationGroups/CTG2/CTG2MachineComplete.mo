within OpenIPSL.Examples.Microgrids.UniversityCampus.CampusA.GenerationGroups.CTG2;
model CTG2MachineComplete
  "Generation group for CTG2 containing the synchronous machine, excitation system, and turbine governor system."
...
equation
  ...
  connect(exciter.VT, machine.ETERM) annotation (Line(points={{-30.09,6.43},{-36,
          6.43},{-36,20},{68,20},{68,-3},{61,-3}}, color={0,0,127}));
  connect(exciter.VOEL, exciter.VUEL) annotation (Line(points={{-9,-25.7},{-9,-50},
          {-16.6,-50},{-16.6,-25.7}}, color={0,0,127}));
end CTG2MachineComplete;
